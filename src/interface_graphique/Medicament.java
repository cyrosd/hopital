...
public class Medicament extends JFrame implements ActionListener {
    ...
    //Donne une couleur de fond  
        ...
        //Affichage TableauMedicament
        TableauMedicament tab = new TableauMedicament();
            ...
            if(choix == "Nom")
                {
                    int i=0;
                    tableau.revalidate();
                    ArrayList<Metier.Medicament> tab2 = tab.getTabmedoc();
                    while(tab2.get(i).getNom() != null)
                    {
            ...
            if(choix == "Type")
                {
                    ...
                    while(tab2.get(i).getNom() != null)
                    {
                        if(tab2.get(i).getType() != zone1.getText())
                        {
                            tab2.remove(i);
                        }
                        i++;
