...
public class Prescription extends JFrame implements ActionListener {
    ...
    //Donne une couleur de fond  
        ...
        //Affichage TableauPrescription
        TableauPrescription tab = new TableauPrescription();
            ...
            if(choix == "Nom Malade")
                {
                    int i=0;
                    tableau.revalidate();
                    ArrayList<Metier.Prescription> tab2 = tab.getTabpres();
            ...
            if(choix == "Medicament")
                {
                    ...
                    while(tab2.get(i).getMalade() != null)
                    {
                        if(tab2.get(i).getMedicament().getNom() != zone1.getText())
                        {
                            tab2.remove(i);
                        }
                        i++;
