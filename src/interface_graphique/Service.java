...
public class Service extends JFrame implements ActionListener {
    ...
    //Donne une couleur de fond  
        ...
        //Affichage TableauService
        TableauService tab = new TableauService();
            ...
            if(choix == "Nom")
                {
                    int i=0;
                    tableau.revalidate();
                    ArrayList<Metier.Service> tab2 = tab.getTabserv();
            ...
            if(choix == "Nom Directeur")
                {
                    ...
                    while(tab2.get(i).getBatiment() != null)
                    {
                        if(tab2.get(i).getDirecteur().getNom() != zone1.getText())
                        {
                            tab2.remove(i);
                        }
                        i++;
