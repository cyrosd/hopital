...
public class Malade extends JFrame implements ActionListener {
    ...
    //Donne une couleur de fond  
        ...
        //Affichage TableauMalade
        TableauMalade tab = new TableauMalade();
            ...
            if(choix == "Mutuelle")
                {
                    int i=0;
                    tableau.revalidate();
                    ArrayList<Metier.Malade> tab2 = tab.getTabmal();
                    while(tab2.get(i).getMutuelle() != null)
                    {
                        if(tab2.get(i).getMutuelle() != zone1.getText())
                        {
                            tab2.remove(i);
                        }
                        i++;
